  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="listTable"
        ...
        <el-table-column label="用户标识" align="center">
...
<script>
  import {fetchList, deleteById} from '@/api/adminLoginLog'
  ...
  export default {
    ...
    methods: {
      ...
      handleUpdate(index, row) {
        let updatePath = '/ums/updateAdminLoginLog'
      ...
      add() {
        let addPath = '/ums/addAdminLoginLog';
