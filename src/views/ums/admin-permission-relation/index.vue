...
<script>
  import {fetchList, deleteById} from '@/api/adminPermissionRelation'
  ...
  export default {
    ...
    methods: {
      ...
      handleUpdate(index, row) {
        let updatePath = '/ums/updateAdminPermissionRelation'
      ...
      add() {
        let addPath = '/ums/addAdminPermissionRelation';
