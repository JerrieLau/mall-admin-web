...
<script>
  import {fetchList, deleteById} from '@/api/adminRoleRelation'
  ...
  export default {
    ...
    methods: {
      ...
      handleUpdate(index, row) {
        let updatePath = '/ums/updateAdminRoleRelation'
      ...
      add() {
        let addPath = '/ums/addAdminRoleRelation';
