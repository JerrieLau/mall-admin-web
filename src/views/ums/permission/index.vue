  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="listTable"
        ...
        <el-table-column label="权限类型，0:目录,1:菜单,2:按钮" align="center">
...
<script>
  import {fetchList, deleteById} from '@/api/permission'
  ...
  export default {
    ...
    methods: {
      ...
      handleUpdate(index, row) {
        let updatePath = '/ums/updatePermission'
